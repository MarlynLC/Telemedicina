...
{
    public class UpdateAsistenteLocalViewModel : AbstractValidator<UpdateAsistenteLocalViewModel>
    {
        //Declaramos las reglas a seguir sobre los datos
        public UpdateAsistenteLocalViewModel()
        {
        ...
        //Modelo de datos para el modificar de un asistenteLocal, para asi separarlo y tener modelos.
