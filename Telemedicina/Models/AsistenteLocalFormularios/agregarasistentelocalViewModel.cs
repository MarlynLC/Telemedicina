...
namespace Telemedicina.Models.AsistenteLocalFormularios
{
    public class agregarasistentelocalViewModel : AbstractValidator<agregarasistentelocalViewModel>
    {
        //Declaramos las reglas a seguir sobre los datos
        public agregarasistentelocalViewModel()
        {
        ...
        //Modelo de datos para el agregar de un asistenteLocal, para asi separarlo y tener modelos.
