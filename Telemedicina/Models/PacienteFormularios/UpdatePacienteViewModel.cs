...
{
    public class UpdatePacienteViewModel : AbstractValidator<UpdatePacienteViewModel>
    {
        //Declaramos la reglas a seguir sobre los datos
        public UpdatePacienteViewModel()
        {
        ...
        //Modelo de datos para la modificacion un Paciente, para asi separarlo y tener modelos.
